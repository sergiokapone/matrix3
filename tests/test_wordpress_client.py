...
class TestWordPressConfig:
    ...
    def test_missing_credentials(self):
        ...
        with pytest.MonkeyPatch().context() as mp:
            ...
            with pytest.raises(ValueError, match="WP_USER або WP_PASSWORD не встановлені"):
                WordPressConfig()
...
class TestWordPressClient:
    ...
    def test_get_page_success(self, wp_client, mock_page_data):
        ...
        responses.add(
            responses.GET, "https://example.com/pages/123",
            json=mock_page_data, status=200
        )
    ...
    def test_get_page_not_found(self, wp_client):
        ...
        responses.add(
            responses.GET, "https://example.com/pages/999",
    ...
    def test_find_page_id_by_slug_success(self, wp_client):
        ...
        responses.add(
            responses.GET, "https://example.com/pages",
            json=[{'id': 123, 'slug': 'test-page'}], status=200
        )
    ...
    def test_create_page_success(self, wp_client, mock_page_data):
        ...
        responses.add(
            responses.POST, "https://example.com/pages",
            json=mock_page_data, status=201
        )
    ...
    def test_update_page_success(self, wp_client, mock_page_data):
        ...
        responses.add(
            responses.POST, "https://example.com/pages/123",
            json=mock_page_data, status=200
        )
    ...
    def test_update_page_not_found(self, wp_client):
        ...
        responses.add(
            responses.POST, "https://example.com/pages/999",
            json={'error': 'Not found'}, status=404
        )
...
class TestWordPressClientEdgeCases:
    ...
    def test_client_with_custom_timeout(self, wp_client):
        ...
        responses.add(
            responses.GET, "https://test.com/pages/1",
    ...
    def test_multiple_pages_found(self, wp_client):
        ...
        responses.add(
            responses.GET, "https://test.com/pages",
            json=[{'id': 1, 'slug': 'test'}, {'id': 2, 'slug': 'test'}], status=200
        )
